...
// fetchall retoma um array com todas aas linhas da consulta ideal para buscar com nome ou endereco 
    ...
    <table class="table table-hover">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-right">
            <!-- Botao de Editar -->
            <a href="editar-curso.php?id_curso=<?php echo $curso['id_curso']; ?>" 
            class="btn btn-warning btn-sm"><i class="glyphicon glyphicon-pencil"></i></a>
            <!-- Botao de Excluir -->

            <!-- on click eh java e serve para dar funcionalidade de alerta ou confirmacao no botao -->
            <a data-toggle="modal" data-target="#modal-exclusao-<?php echo $curso['id_curso']; ?>"
             href="#" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-trash" ></i></a>
